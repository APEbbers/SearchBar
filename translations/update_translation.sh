...
# LUPDATE="C:/Program Files/FreeCAD 1.0/bin/Lib/site-packages/PySide/lupdate" # from Qt6
LUPDATE=/usr/lib/qt6/bin/lupdate # from Qt6
# LUPDATE=lupdate                  # from Qt5
# LRELEASE="C:/Program Files/FreeCAD 1.0/bin/Lib/site-packages/PySide/lrelease" # from Qt6
